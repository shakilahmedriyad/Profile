...
export default function Contacts() {
  ...
  return (
    <div className=" py-7 mt-28 mb-10 text-gray-100 flex flex-col justify-center items-center  ">
      <Toaster position="top-right" />
      <div className="px-24 shadow-xl py-16 rounded-md bg-[#171717] ">
        <div className=" w-[80%] sm:w-[60%] md:w-[35rem] text-sm ">
